...
export function CandidateCard({
  ...
  return (
    <>
      <div className="p-3 bg-white rounded-lg border border-slate-200 shadow-xs hover:border-slate-300 transition-all space-y-2.5 group">
        ...
        <div className="pt-2 border-t border-slate-100 flex items-center justify-between gap-1">
          ...
          <div className="flex items-center gap-1">
            <button
              ...
              title="Voltar etapa"
              className="h-6 w-6 rounded border border-slate-200 flex items-center justify-center text-slate-500 hover:bg-slate-100 disabled:opacity-30 disabled:pointer-events-none"
            >
          ...
          {candidate.stage === 'aprovado' ? (
            <Button
              ...
              className="h-7 text-[11px] bg-emerald-600 hover:bg-emerald-700 font-bold px-2 py-0 gap-1 shadow-xs"
            >
